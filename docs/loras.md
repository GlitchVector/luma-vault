...
| `zkemet_v1` | `zkemet` | full | Zahra Kemet, the owner's original Egyptian-themed character: dark brown wavy shoulder-length hair, brown eyes, tan skin, red lips, gold disc earrings, gold collar with a red gem, red halter dress with a plunging neckline over a draped red pelvic curtain, gold ram-buckle belt with chains, winged gold bracers, gold gladiator stiletto sandals. Render words: `(egyptian clothes:1.3), (red dress:1.3), (halter dress:1.2), (plunging neckline:1.3), (pelvic curtain:1.3), loincloth, bare hips, (gold belt:1.2), chain, (bracer:1.2), armlet, (gold earrings:1.2), (gold choker:1.2), (dark skin:1.3)`; feet `(gladiator sandals:1.3), (high heels:1.2), gold footwear, anklet`; rears `(backless dress:1.2)`; negate `pale skin, white skin, boots, gloves, leotard, bodysuit, headdress, crown, long hair` | `zkemet_v1` training 2026-09-13 01:15 (10 epochs) |
