...
| `ari_v1` | `ari` | full | **Ari** (the owner's name; her sheet says Aurora), original character: white-to-teal bob with blunt bangs and teal-dipped ends, blue eyes, glossy lips, teal headband with a blue cabochon, blue teardrop earrings, black choker with a blue gem pendant, teal off-shoulder crop top with a black yoke and long puffed sleeves, white high-waisted shorts with two rows of black buttons, white beaded bracelet, white chunky platform sneakers with teal accents. Render words: `(crop top:1.3), (off-shoulder:1.3), bare shoulders, long sleeves, (puffy sleeves:1.2), (aqua shirt:1.3), two-tone shirt, black shirt, turtleneck, midriff, navel, (white shorts:1.3), high-waist shorts, buttons`; feet `(sneakers:1.3), (platform footwear:1.2), (white footwear:1.2)`; hair `(white hair:1.2), (aqua hair:1.2), gradient hair, colored tips, (bob cut:1.3), blunt bangs, (headband:1.2)`; negate `long hair, ponytail, boots, heels, dress, skirt, thighhighs`. Her sheet carries nine labelled detail panels (face, eye, lips, necklace, earring, headband, sleeve, shorts, shoes) - their boxes were measured from the pixels rather than guessed, after a first pass caught the DETAILS header | `ari_v1` proofs 2026-09-13 13:35: 6/6 on-sheet (bob with teal tips, headband, gem choker, off-shoulder teal crop top with puffed sleeves, white buttoned high-waist shorts, platform sneakers, bracelet); miss: the black turtleneck yoke under the top is faint or absent on most frames - weight `(black shirt:1.2), turtleneck` when it matters; round 1 done 14:01 (41/42, one two-figure drop - the 4-view sheet turnaround, now negated in both her scripts); **Use `ari_v3`** (2026-09-13 18:19): the layered top is trained in and holds on 6/6 proofs from every angle, including the yoke from behind. v2 could not: 25 of its 41 round-1 keepers showed a black bust with teal sleeves, so v3 drops those (keeping the 16 topless/nude/head-only ones) and adds `crops-top/`, the sheet's four chest crops, at x30. v2 was called working 15:25, with one correction the same day. I first reported the black panel as fixed; it was not, and a detail render dropped it entirely. **Her top is TWO garments, and the original captions described it as one** - that is the root error: a black sleeveless turtleneck crop top (high collar, shoulder yoke, bare shoulder cutouts) worn UNDER a teal off-shoulder crop top with puffed sleeves and black wrist cuffs. Prompt it as `(layered clothes:1.3), (black turtleneck:1.4), (sleeveless turtleneck:1.3), high collar, (black crop top:1.3), (bare shoulders:1.2)` before the teal half, and never negate `black crop top` - doing so deletes the panel it was meant to protect. **The small parts need naming, though** (owner 2026-09-13: "the outfit is missing some details"): the sheet's nine detail panels are tiny inside the four full views, so the headband gem, the gold pendant, the sleeve cuffs and the shorts' buttons come out plain unless the prompt asks. Working additions, verified: identity gets `(teal hairband:1.4), hairband, (gem:1.2), blue gemstone, gold trim, (gold necklace:1.3), (pendant:1.3), (black choker:1.2), (blue earrings:1.2), bracelet`; wardrobe gets `(aqua shirt:1.4), (two-tone shirt:1.2), (black cuffs:1.2)` and `(black buttons:1.4), (double-breasted:1.2)`. Keep the button words in the *shorts* chunk and negate `(gold buttons:1.4), (buttons on shirt:1.3), (tube top:1.4), (strapless:1.4)` - unscoped the buttons march up onto the top and turn gold, and without the tube-top negative the black turtleneck is dropped. All of this is in `ari-lora-test.mjs` |
