...
| `zkemet_v1` | `zkemet` | full | Zahra Kemet, the owner's original Egyptian-themed character: dark brown wavy shoulder-length hair, brown eyes, tan skin, red lips, gold disc earrings, gold collar with a red gem, red halter dress with a plunging neckline over a draped red pelvic curtain, gold ram-buckle belt with chains, winged gold bracers, gold gladiator stiletto sandals. Render words: `(egyptian clothes:1.3), (red dress:1.3), (halter dress:1.2), (plunging neckline:1.3), (pelvic curtain:1.3), loincloth, bare hips, (gold belt:1.2), chain, (bracer:1.2), armlet, (gold earrings:1.2), (gold choker:1.2), (dark skin:1.3)`; feet `(gladiator sandals:1.3), (high heels:1.2), gold footwear, anklet`; rears `(backless dress:1.2)`; negate `pale skin, white skin, boots, gloves, leotard, bodysuit, headdress, crown, long hair` | `zkemet_v1` proofs 2026-09-13 04:40: 6/6 on-sheet (halter dress, plunging neckline, pelvic curtain, ram-buckle belt with chains and pendant, winged bracers, gold collar and disc earrings, cross-laced sandals, tan skin); misses: the drape panels reach the floor instead of ending mid-calf, and the straight-on front wears flat sandals instead of the stiletto heels; round 1 (42) running |
