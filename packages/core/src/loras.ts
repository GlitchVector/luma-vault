...
export const CUSTOM_LORAS: readonly LoraEntry[] = [
  ...
  },
  {
    ...
    kind: 'full',
    description:
      'Ari again, from the 35-view reference set generated off her own character sheet (2026-09-21): the same white-to-aqua bob, teal top with the black yoke, white shorts and platform sneakers, on ten different backgrounds.',
    status: 'wip',
    weight: 1.2,
    olderVersions: [],
