...
export const CUSTOM_LORAS: readonly LoraEntry[] = [
  ...
  },
  {
    ...
    status: 'wip',
    weight: 1.2,
    olderVersions: ['ari_gen_v5', 'ari_gen_v4', 'ari_gen_v3', 'ari_gen_v2', 'ari_gen_v1', 'ari_gen_s1'],
    note: 'v6 = v5 data unchanged + 12 dressed back and side views (the white shorts from behind), trained to the full reference budget through the gate (43 epochs, ~20,000 steps) - v1-v5 all ran at 62 % of it, the cause of the colour shuffle (same-check 2026-09-24: adopt_v4 3/16 wrong, gen_v5 6/16, adopt_v4 cut to gen_v5 length 7/16). Not trained yet; waits for the owner\'s go.',
  },
  {
  ...
  // The origin comic's cast (2026-09-25): entered at reference time, before any data exists, so
  // the cards show the owner's approved sheet and a later session picks up generation and training.
  {
    name: 'tom_gen_s1',
    dataset: 'tomx',
    outfit: null,
    ...
    kind: 'full',
    description:
      'Lanky Latino man, 21, light brown tan, short dark curls, light stubble, a small soft belly; iridescent charcoal gilet with acid-yellow shoulder tape over a white T-shirt, a leather tool harness, olive cargo trousers with copper knee patches, brown work boots, steel bearing rings on the left wrist.',
    status: 'wip',
    weight: null,
    olderVersions: [],
    note: 'Reference only: the four figures of the approved parts-stall sheet. Next: the generator needs a he/him pronoun setting, then `pnpm refs generate tomx --vault`. Not yet generated or trained.',
  },
  {
    name: 'tom_gen_gala_s1',
    dataset: 'tomx-gala',
    outfit: 'Gala',
    parent: 'tom_gen_s1',
    trigger: 'tomxgala',
    character: 'Tom',
    kind: 'outfit',
    description: 'Tom at 25 at the gala: a charcoal-brown suit worn open, a white shirt with the collar open and no tie, acid-yellow socks, glossy black derbies, the bearing rings on the left wrist.',
    status: 'wip',
    weight: null,
    olderVersions: [],
    note: 'Reference only: the approved gala sheet. Shares the head shots of tomx. Not yet generated or trained.',
  },
  {
    name: 'hernan_gen_s1',
    dataset: 'hquintero',
    ...
    parent: null,
    trigger: 'hquintero',
    character: 'Hernán Quintero',
    kind: 'full',
    description:
      'Colombian engineer, 33, 174 cm, a bit chubby with a wide torso, heavy black brows, a thick black moustache, bold amber tortoiseshell glasses worn on his face; heather-grey T-shirt, dark jeans, grey sneakers.',
    status: 'wip',
    weight: null,
    olderVersions: [],
    note: "Ari's father. Reference only: the approved age-33 sheet. Next: the generator's he/him pronoun setting, then `pnpm refs generate hquintero --vault`. Not yet generated or trained.",
  },
  {
    name: 'hernan_gen_age_46_s1',
    dataset: 'hquintero-age-46',
    outfit: 'Age 46',
    parent: 'hernan_gen_s1',
    trigger: 'hquinteroage46',
    character: 'Hernán Quintero',
    kind: 'outfit',
    description: 'Hernán at 46: heavily grey hair and moustache, the amber glasses; a crisp white shirt with rolled sleeves and a stylus in the pocket, a brown belt, charcoal trousers, brown derbies.',
    status: 'wip',
    weight: null,
    olderVersions: [],
    note: 'Reference only: the approved age-46 sheet. Needs its OWN head shots - the face and hair are older. Not yet generated or trained.',
  },
  {
    name: 'yunji_gen_s1',
    dataset: 'yjmin',
    ...
    parent: null,
    trigger: 'yjmin',
    character: 'Min Yun-ji',
    kind: 'full',
    description:
      'Korean woman, 29, 176 cm, very long firm legs, pale skin, greenish-grey eyes, black hair in a top bun with one lavender strand in the fringe; sage T-shirt, beige half-apron with a pencil, rolled light jeans, off-white canvas sneakers.',
    status: 'wip',
    weight: null,
    olderVersions: [],
    note: "Ari's mother. Reference only: the approved age-29 sheet. Next: `pnpm refs generate yjmin --vault`. Not yet generated or trained.",
  },
  {
    name: 'yunji_gen_age_42_s1',
    dataset: 'yjmin-age-42',
    outfit: 'Age 42',
    parent: 'yunji_gen_s1',
    trigger: 'yjminage42',
    character: 'Min Yun-ji',
    kind: 'outfit',
    description: 'Yun-ji at 42: long loose black hair with a few grey strands and the lavender strand; a cream shirt with clipped sleeves, an olive bib apron that covers only the front, charcoal leggings, grey-green knit trainers.',
    status: 'wip',
    weight: null,
    olderVersions: [],
    note: 'Reference only: the approved age-42 sheet. Needs its OWN head shots - older face, long loose hair. Not yet generated or trained.',
  },
  {
    name: 'nev_gen_s1',
    dataset: 'ndreyer',
    ...
    parent: null,
    trigger: 'ndreyer',
    character: 'Nev Dreyer',
    kind: 'full',
    description:
      'Lean blond man, 23, 189 cm, honey-blond side-swept hair with a cowlick, freckles, a gap between his front teeth; pastel apricot technician shirt with darker-peach bars and black buttons, black belt, black trousers, black derbies.',
    status: 'wip',
    weight: null,
    olderVersions: [],
    note: "Ari's schoolmate, the bully. Adult only: his 14 and 16 sheets are references for the flashbacks and are never trained. Next: the generator's he/him pronoun setting, then `pnpm refs generate ndreyer --vault`.",
  },
]
